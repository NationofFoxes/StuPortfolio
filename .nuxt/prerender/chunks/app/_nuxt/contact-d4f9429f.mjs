...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<article${ssrRenderAttrs(mergeProps({
    ...
    "data-page": "contact"
  }, _attrs))}><header><h2 class="h2 article-title">Contact</h2></header><div class="separator"></div><ul class="contacts-list"><li class="contact-item"><div class="icon-box">`);
...
//# sourceMappingURL=contact-d4f9429f.mjs.map
