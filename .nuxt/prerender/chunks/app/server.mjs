...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-4b553726.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8aa2eeee.mjs').then((m) => m.default || m)
  },
  {
    name: "portfolio",
    path: "/portfolio",
...
const layouts = {
  default: () => import('./_nuxt/default-9c213e3a.mjs').then((m) => m.default || m),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-ffc6a0d6.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-36c2b6f5.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, _imports_0 as a, createError as c, entry$1 as default, navigateTo as n, useRouter as u };
