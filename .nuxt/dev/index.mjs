globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\stuar\\Programming\\StuPortfolio\\StuPortfolio","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\stuar\\Programming\\StuPortfolio\\StuPortfolio\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\stuar\\Programming\\StuPortfolio\\StuPortfolio\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\stuar\\Programming\\StuPortfolio\\StuPortfolio\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\stuar\\Programming\\StuPortfolio\\StuPortfolio\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _UzG3qdeLOw = (function(nitro) {
...
const _lazy_dsoE9Q = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_dsoE9Q, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dsoE9Q, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/stuar/Programming/StuPortfolio/StuPortfolio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
